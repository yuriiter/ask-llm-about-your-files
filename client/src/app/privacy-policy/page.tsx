    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc ml-6">
        <li>
          ...
          information that you provide to us when you register, log in, or
          interact with our website, such as your name, email address, and
          contact details.
        </li>
        <li>
        ...
        <li>
          ...
          and similar tracking technologies to monitor activity on our website
      ...
      <ul className="list-disc ml-6">
        ...
        <li>
          For business transfers, such as merging or acquiring other businesses.
        </li>
        <li>
          With affiliates, in which case we will require those affiliates to
          honor this Privacy Policy.
        </li>
        <li>
          With your consent, for any other purpose we disclose at the time you
