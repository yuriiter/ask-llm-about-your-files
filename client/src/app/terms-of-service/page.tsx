    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc ml-6">
        ...
        <li>
          ...
          manner that could damage, disable, overburden, or impair the website.
        </li>
      </ul>
      ...
      <p>
        ...
        are owned by or licensed to us. You may not reproduce, distribute, or
        create derivative works from any content on our website without our
      ...
      <p>
        ...
        of these third-party sites. You acknowledge and agree that we are not
        liable for any damages or losses caused by your use of these sites.
      </p>
      ...
      <p>
        ...
        your use of the website, even if we have been advised of the possibility
        of such damages.
      </p>
      ...
      <p>
        ...
        with the laws of [Your Jurisdiction]. Any legal action or proceeding
        arising out of or relating to these Terms shall be brought exclusively
      ...
      <ul className="list-disc ml-6">
        <li>Email: admin@vector-search.com</li>
        <li>Website: vector-search.com</li>
      </ul>
    </div>
  );
}
